...
public class UpdateServiceTest
{
        ...
        throws IOException, ArchiveException
    {
        ...
        server.expect(requestTo("http://localhost:8888/eFaps/api/checkout?oid=1.1"))
        ...
        server.expect(requestTo("http://localhost:8888/eFaps/api/checkout?oid=1.2"))
                        .andRespond(MockRestResponseCreators
        ...
        server.expect(requestTo("http://localhost:8888/eFaps/api/checkout?oid=1.3"))
        .andRespond(MockRestResponseCreators
