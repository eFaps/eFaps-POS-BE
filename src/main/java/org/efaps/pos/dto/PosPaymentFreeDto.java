...
@JsonDeserialize(builder = PosPaymentFreeDto.Builder.class)
@JsonInclude(Include.NON_NULL)
public class PosPaymentFreeDto
    ...
    implements IPosPaymentDto
{
    ...
    protected PosPaymentFreeDto(final Builder builder)
    {
        super(builder);
    ...
    public static class Builder
        extends PaymentAbstractDto.Builder<PosPaymentFreeDto.Builder>
    {

        private final PaymentType type = PaymentType.FREE;
        ...
        public PosPaymentFreeDto build()
        {
            return new PosPaymentFreeDto(this);
        }
    }
}
