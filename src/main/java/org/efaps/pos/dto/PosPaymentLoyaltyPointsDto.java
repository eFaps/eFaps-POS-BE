...
public class PosPaymentLoyaltyPointsDto
    ...
    implements IPosPaymentDto
{
    ...
    protected PosPaymentLoyaltyPointsDto(final Builder builder)
    {
        super(builder);
    ...
    public static class Builder
        extends PaymentLoyaltyPointsAbstractDto.Builder<PosPaymentLoyaltyPointsDto.Builder>
    {
        ...
        public PosPaymentLoyaltyPointsDto build()
        {
            return new PosPaymentLoyaltyPointsDto(this);
        }
    }
}
