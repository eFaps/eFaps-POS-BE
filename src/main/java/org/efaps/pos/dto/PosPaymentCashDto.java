...
@JsonDeserialize(builder = PosPaymentCashDto.Builder.class)
@JsonInclude(Include.NON_NULL)
public class PosPaymentCashDto
    ...
    implements IPosPaymentDto
{
    ...
    protected PosPaymentCashDto(final Builder builder)
    {
        super(builder);
    ...
    public static class Builder
        extends PaymentAbstractDto.Builder<PosPaymentCashDto.Builder>
    {
        ...
        public PosPaymentCashDto build()
        {
            return new PosPaymentCashDto(this);
        }
    }
}
