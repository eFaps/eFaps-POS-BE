...
@JsonDeserialize(builder = PosPaymentChangeDto.Builder.class)
@JsonInclude(Include.NON_NULL)
public class PosPaymentChangeDto
    ...
    implements IPosPaymentDto
{
    ...
    protected PosPaymentChangeDto(final Builder builder)
    {
        super(builder);
    ...
    public static class Builder
        extends PaymentAbstractDto.Builder<PosPaymentChangeDto.Builder>
    {

        private final PaymentType type = PaymentType.CHANGE;
        ...
        public PosPaymentChangeDto build()
        {
            return new PosPaymentChangeDto(this);
        }
    }
}
